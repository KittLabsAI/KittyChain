...
- After calling this tool, use address_malicious and web_browser to look up the address on https://www.oklink.com/ to verify the result and gather more insights such as token risk, token metadata, and related addresses.
    """
    parameters = {
        "type": "object",
        "properties": {
